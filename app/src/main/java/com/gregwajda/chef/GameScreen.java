...
import com.gregwajda.framework.Game;
import com.gregwajda.framework.Graphics;
import com.gregwajda.framework.Image;
import com.gregwajda.framework.Input.TouchEvent;
import com.gregwajda.framework.Screen;

public class GameScreen extends Screen {
	enum GameState {
		Ready, Running, Paused, GameOver, GameWon
	}
	...
	public GameScreen(Game game) {
        ...
        hb3 = new Heliboy(6500,360);
        hb4 = new Heliboy(1000,360);
	...
	private void updateRunning(List touchEvents, float deltaTime) {
        ...
        if (robot.getCenterY() > 500 && score == 4) {
    ...
    private void updateGameWon(List touchEvents) {
        int len = touchEvents.size();
        for (int i = 0; i < len; i++) {
            TouchEvent event = (TouchEvent) touchEvents.get(i);
            if (event.type == TouchEvent.TOUCH_DOWN) {
	...
	public void paint(float deltaTime) {
        ...
        g.drawString(Integer.toString(score),740,75,paint3);
	...
	private void drawReadyUI() {
		...
		g.drawString("Tap to Start Cookin'.", 400, 240, paint);
	...
	private void drawGameOverUI() {
		Graphics g = game.getGraphics();
		g.drawRect(0, 0, 1281, 801, Color.BLACK);
		g.drawString("Fried", 400, 240, paint2);
		g.drawString("Tap to return", 400, 290, paint);
        score = 0;
