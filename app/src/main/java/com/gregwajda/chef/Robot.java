...
public class Robot {
    ...
    public void update() {
        ...
        rect3.set(rect.left - 26, rect.top+32, rect.left-25, rect.top+52);
        rect4.set(rect.left + 68, rect.top+32, rect.left+69, rect.top+52);
        yellowRed.set(centerX - 110, centerY - 110, centerX + 70, centerY + 70);
        footleft.set(centerX - 50, centerY + 20, centerX-35, centerY + 35);
        footright.set(centerX, centerY + 20, centerX+35, centerY+35);
